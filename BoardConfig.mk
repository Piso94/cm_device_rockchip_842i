...
-include vendor/rockchip/842i/BoardConfigVendor.mk
...
#TARGET_KERNEL_CONFIG    := CM10_842i_defconfig

TARGET_PREBUILT_KERNEL := device/rockchip/842i/kernel
DEVICE_RESOLUTION := 1024x768

TARGET_SPECIFIC_HEADER_PATH := device/rockchip/842i/include

# Releasetools
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := ./device/rockchip/842i/releasetools/ota_from_target_files
#TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := ./device/rockchip/842i/releasetools/842i_img_from_target_files
TARGET_CUSTOM_RELEASETOOL := ./device/rockchip/842i/releasetools/squisher

# Camera
BOARD_USES_LEGACY_CAMERA := false

#Graphics
BOARD_EGL_CFG := device/rockchip/842i/egl.cfg
...
#recovery
TARGET_RECOVERY_INITRC := device/rockchip/842i/recovery_init.rc
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/rockchip/842i/recovery_keys.c
